...
BEGIN
  ...
  SELECT COUNT(*) INTO existe FROM ASIGNATURA WHERE (W_NOMBRE = NOMBRE
  AND W_ESPECIALIDAD = ESPECIALIDAD AND oidp = PROFESOR AND W_MATRICULA = MATRICULA);
  IF (existe = 0) THEN
...
AS 
  ...
  existe INTEGER;
BEGIN
  SELECT max(OID_A) INTO oida FROM ASIGNATURA WHERE NOMBRE = W_ASIG;
...
ELSIF(W_CURSO = 'MUSICA Y MOVIMIENTO 3')
  THEN INSERT INTO MATRICULA VALUES(SEC_MATRICULA.NEXTVAL,W_AÑO,W_CURSO,35,W_ALUMNO);
    ...
    SELECT TIENE.ESPECIALIDAD INTO esp FROM TIENE WHERE ALUMNO = W_ALUMNO;

   INSERTAR_PROFESOR('58566605A','Virginia Pérez','01/03/1987','685811394','vir_2004@hotmail.com');
   INSERTAR_ASIGNATURA('INICIACIÓN MUSICAL','58566605A',SEC_MATRICULA.CURRVAL, esp);
...
ELSIF(W_CURSO = 'PREPARATORIO 1')
  ...
  END IF;
  INSERTAR_PROFESOR('58566605A','Virginia Pérez','01/03/1987','685811394','vir_2004@hotmail.com');
  INSERTAR_ASIGNATURA('LENGUAJE MUSICAL','58566605A',SEC_MATRICULA.CURRVAL, esp);
  ...
  INSERTAR_ASIGNATURA('CORO','00848456D',SEC_MATRICULA.CURRVAL, esp);
  ...
  INSERTAR_ASIGNATURA('INSTRUMENTO COLECTIVO','72162835J',SEC_MATRICULA.CURRVAL, esp);
...
ELSIF(W_CURSO = 'PRIMERO ELEMENTAL')
  ...
  INSERTAR_PROFESOR('72162835J','Amparo Vega Cabrera','01/03/1987','685811394','vegamparo@hotmail.com');
  INSERTAR_ASIGNATURA('INSTRUMENTO INDIVIDUAL','72162835J',SEC_MATRICULA.CURRVAL, esp);
  INSERTAR_HORARIO('MIÉRCOLES','01/01/2000 17:00:00',1);
...
ELSIF(W_CURSO = 'SEGUNDO ELEMENTAL')
  ...
  INSERTAR_PROFESOR('58566605A','Virginia Pérez','01/03/1987','685811394','vir_2004@hotmail.com');
  INSERTAR_ASIGNATURA('BANDA','58566605A',SEC_MATRICULA.CURRVAL, esp);
 ...
 ELSIF(W_CURSO = 'TERCERO ELEMENTAL')
  ...
  INSERTAR_ASIGNATURA('LENGUAJE MUSICAL','92479300A',SEC_MATRICULA.CURRVAL, esp);
  INSERTAR_HORARIO('LUNES','01/01/2000 17:00:00',2);
  INSERTAR_POSEE(SEC_HORARIO.CURRVAL,'LENGUAJE MUSICAL');
  INSERTAR_REALIZA(W_ALUMNO,'LENGUAJE MUSICAL');
  ...
  INSERTAR_ASIGNATURA('BANDA','06328209N',SEC_MATRICULA.CURRVAL, esp);
  INSERTAR_HORARIO('VIERNES','01/01/2000 20:00:00',1);
  INSERTAR_POSEE(SEC_HORARIO.CURRVAL,'BANDA');
  INSERTAR_REALIZA(W_ALUMNO,'BANDA');
  COMMIT WORK;
...
ELSIF(W_CURSO = 'SOLO INSTRUMENTO')
  ...
  INSERTAR_PROFESOR('06328209N','Carlos Fernández','01/03/1987','685811394','carlos@hotmail.com');
  INSERTAR_ASIGNATURA('INSTRUMENTO INDIVIDUAL','06328209N',SEC_MATRICULA.CURRVAL, esp);
  INSERTAR_HORARIO('VIERNES','01/01/2000 20:00:00',1);
  INSERTAR_POSEE(SEC_HORARIO.CURRVAL,'INSTRUMENTO INDIVIDUAL');
  INSERTAR_REALIZA(W_ALUMNO,'INSTRUMENTO INDIVIDUAL');
  COMMIT WORK;
